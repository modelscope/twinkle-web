...
欢迎来到 Twinkle 文档！Twinkle 是一个轻量级的客户端-服务端训练框架，具有模块化、高内聚的接口设计，专为大语言模型训练打造。

<!--more-->

无论您是定制训练算法的研究者、构建生产训练流水线的开发者，还是部署训练即服务的企业，本文档都将帮助您快速上手。
...
{{< cards >}}
  ...
  {{< card url="usage-guide/" title="实战教程" icon="document-text" subtitle="分步指南：快速开始、Qwen3.5、Embedding 训练" >}}
